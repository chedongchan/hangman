...
cylinder1 = Cylinder(1,5).get_surface_area()
cylinder2= Cylinder(1,7).get_volume()
print(cylinder1)
print(cylinder2)
...
# I prefer my code for the Hangman Project because it is more interactive with the user.
# However, to complete the assignment, I have followed the template for the Hangman Project shown below.
...
# This code appears to work in both situations. 
